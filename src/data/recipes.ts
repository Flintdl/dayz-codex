...
export const RECIPES: Recipe[] = [
  ...
  {
    slug: "skin-rabbit",
    output: { itemSlug: "raw-rabbit", qty: 2 },
    inputs: [],
    tools: ["kitchen-knife"],
    method: "Use Knife na carcaça do coelho → 'Skin and Quarter'. Também gera 1 rabbit-pelt + bones.",
    durationS: 8,
    category: "food",
    notes: "Stone knife funciona; hatchet também serve mas estraga mais.",
  },
  {
    slug: "skin-chicken",
    output: { itemSlug: "raw-chicken", qty: 1 },
    inputs: [],
    tools: ["kitchen-knife"],
    method: "Knife na galinha morta → 'Skin and Quarter'. Gera raw-chicken + feathers + bones.",
    durationS: 6,
    category: "food",
    notes: "Penas (feathers) reutilizáveis para arrows.",
  },
  {
    slug: "skin-deer",
    output: { itemSlug: "raw-steak", qty: 5 },
    inputs: [],
    tools: ["kitchen-knife"],
    method: "Knife na carcaça do cervo → 'Skin and Quarter'. Rende 4-6 venison steaks + 1 deer-pelt + bones + lard + intestines.",
    durationS: 25,
    category: "food",
    notes: "Quarter primeiro animais grandes pra acessar em pedaços.",
  },
  {
    slug: "skin-cow",
    output: { itemSlug: "raw-steak", qty: 7 },
    inputs: [],
    tools: ["kitchen-knife"],
    method: "Knife na vaca abatida → 'Skin and Quarter'. Rende 6-8 raw-steak + 1 cow-pelt + bones + lard.",
    durationS: 30,
    category: "food",
    notes: "Maior fonte de calorias do jogo — vale o tempo de retalhar.",
  },
  {
    slug: "skin-pig",
    output: { itemSlug: "raw-steak", qty: 7 },
    inputs: [],
    tools: ["kitchen-knife"],
    method: "Knife no porco → 'Skin and Quarter'. Rende 6-8 pork steaks + pig-pelt + bones + lard.",
    durationS: 28,
    category: "food",
  },
  {
    slug: "skin-wolf",
    output: { itemSlug: "raw-steak", qty: 4 },
    inputs: [],
    tools: ["kitchen-knife"],
    method: "Knife no lobo → 'Skin and Quarter'. Rende wolf steaks + wolf-pelt + bones.",
    durationS: 20,
    category: "food",
    notes: "Carne de lobo tem maior risco de doença/trichinellosis — cozinhe bem.",
  },
  {
    slug: "skin-bear",
    output: { itemSlug: "raw-steak", qty: 8 },
    inputs: [],
    tools: ["kitchen-knife"],
    method: "Knife no urso morto → 'Skin and Quarter'. Rende bear steaks + bear-pelt + bones + lard.",
    durationS: 40,
    category: "food",
    notes: "Pelt de urso é o item mais cobiçado para vestuário/improvised-backpack premium.",
  },
  {
    slug: "quarter-large-animal",
    output: { itemSlug: "raw-meat-pile", qty: 1 },
    inputs: [],
    tools: ["kitchen-knife", "hatchet"],
    method: "Use Knife/Hatchet em carcaça grande → 'Quarter'. Divide em pedaços menores para retalhar (skin) depois.",
    durationS: 15,
    category: "food",
    notes: "Necessário em cervo/vaca/urso antes de extrair steaks individuais.",
  },

  // ─── COOKING AVANÇADO ─────────────────────────────────
  {
    slug: "cook-bear-steak",
    output: { itemSlug: "cooked-steak", qty: 1 },
    inputs: [{ itemSlug: "raw-steak", qty: 1 }],
    tools: ["cooking-tripod", "cooking-pot", "frying-pan"],
    method: "Bear steak no espeto/pan/pot sobre fogo → 'Cooked' (~2 min em frying pan).",
    durationS: 120,
    category: "food",
    notes: "Bear steak rende muito mais calorias que cervo/vaca. Não passe direto a 'Burned'.",
  },
  {
    slug: "cook-venison-steak",
    output: { itemSlug: "cooked-steak", qty: 1 },
    inputs: [{ itemSlug: "raw-steak", qty: 1 }],
    tools: ["cooking-tripod", "cooking-pot", "frying-pan"],
    method: "Venison no espeto, pan ou pot sobre fogo → 'Cooked'.",
    durationS: 90,
    category: "food",
  },
  {
    slug: "dry-meat-smokehouse",
    output: { itemSlug: "cooked-steak", qty: 1 },
    inputs: [{ itemSlug: "raw-steak", qty: 1 }],
    method: "Pendure raw-steak no smokehouse aceso → 'Dried' após ~5 min. Carne seca dura muito mais sem apodrecer.",
    durationS: 300,
    category: "food",
    notes: "Smokehouse = base building dedicada (ver categoria base). Ideal pra estocar carne para travessias.",
  },
  {
    slug: "lard-from-fat",
    output: { itemSlug: "lard", qty: 1 },
    inputs: [{ itemSlug: "fat", qty: 1 }],
    tools: ["cooking-pot"],
    method: "Coloque fat trim em cooking-pot sobre fogo → derrete em lard ao longo de ~3 min.",
    durationS: 180,
    category: "food",
    notes: "Lard usado pra cura de couro e como combustível alternativo para frying pan.",
  },
  {
    slug: "bake-fruit-stick",
    output: { itemSlug: "apple", qty: 1 },
    inputs: [
      { itemSlug: "long-stick", qty: 1 },
      { itemSlug: "apple", qty: 1 },
    ],
    method: "Combine fruit + long-stick → espete-a sobre campfire/fireplace → 'Baked Fruit'.",
    durationS: 60,
    category: "food",
    notes: "Funciona com apple/pear/plum/peach. Aumenta nutrição e remove parte do risco de cólera de fruta crua suja.",
  },

  // ─── TOOLS / IMPROVISED ───────────────────────────────
  {
    slug: "craft-stone-knife",
    output: { itemSlug: "stone-knife", qty: 1 },
    inputs: [
      { itemSlug: "small-stone", qty: 2 },
      { itemSlug: "wooden-stick", qty: 1 },
    ],
    method: "Combine 2 small-stones + 1 wooden-stick → 'Craft Stone Knife'.",
    durationS: 10,
    category: "tool",
    notes: "Primeira lâmina sem loot — abre carcaças e corta rags.",
  },
  {
    slug: "sharpen-knife",
    output: { itemSlug: "kitchen-knife", qty: 1 },
    inputs: [{ itemSlug: "kitchen-knife", qty: 1 }],
    tools: ["sharpening-stone"],
    method: "Combine sharpening-stone com qualquer faca → repara até Pristine.",
    durationS: 5,
    category: "tool",
    notes: "1 sharpening-stone = ~5 usos. Funciona em kitchen/combat/hunting/steak/stone knife.",
  },
  {
    slug: "sharpen-hatchet",
    output: { itemSlug: "hatchet", qty: 1 },
    inputs: [{ itemSlug: "hatchet", qty: 1 }],
    tools: ["sharpening-stone"],
    method: "Sharpening-stone em hatchet/fire-axe/pickaxe → repara até Pristine.",
    durationS: 5,
    category: "tool",
  },
  {
    slug: "craft-fishing-hook-bone",
    output: { itemSlug: "fishing-hook", qty: 1 },
    inputs: [{ itemSlug: "bone", qty: 1 }],
    tools: ["kitchen-knife"],
    method: "Use Knife em bones → 'Carve Improvised Hook'. Rende 1 anzol improvisado.",
    durationS: 8,
    category: "tool",
    notes: "Alternativa quando não encontra hook de loot. Combine com long-stick + rope = fishing rod improvisada.",
  },
  {
    slug: "craft-improvised-eye-patch",
    output: { itemSlug: "eye-patch", qty: 1 },
    inputs: [
      { itemSlug: "rags", qty: 1 },
      { itemSlug: "rope", qty: 1 },
    ],
    method: "Combine 1 rag + 1 rope → 'Craft Eye Patch'.",
    durationS: 6,
    category: "clothing",
    notes: "Cobre slot de olho — útil cosmético/roleplay; não bloqueia dano.",
  },
  {
    slug: "craft-improvised-leather-belt",
    output: { itemSlug: "leather-belt", qty: 1 },
    inputs: [{ itemSlug: "cured-pig-pelt", qty: 1 }],
    tools: ["leather-sewing-kit"],
    method: "Combine cured-pelt + leather-sewing-kit → 'Craft Leather Belt'.",
    durationS: 12,
    category: "clothing",
    notes: "Adiciona 2 slots ao slot de cinto. Mais durável que belt de loot militar.",
  },

  // ─── TANNING / LEATHERWORKING ─────────────────────────
  {
    slug: "prepare-tanning-tub",
    output: { itemSlug: "tanning-tub", qty: 1 },
    inputs: [
      { itemSlug: "barrel", qty: 1 },
      { itemSlug: "lime-powder", qty: 1 },
    ],
    method: "Combine barrel + garden-lime + encha com água (canteen/bottle ou chuva) → vira tanning-tub ativo.",
    durationS: 20,
    category: "base",
    notes: "Solução de cal+água curte couro. Barrel pode ser reaproveitado depois de esvaziar.",
  },
  {
    slug: "tan-leather",
    output: { itemSlug: "cured-pig-pelt", qty: 1 },
    inputs: [{ itemSlug: "deer-pelt", qty: 1 }],
    tools: ["tanning-tub"],
    method: "Coloque raw pelt (rabbit/deer/cow/wolf/bear/pig) no tanning-tub preparado → aguarde ~20 min → 'Cured Pelt'.",
    durationS: 1200,
    category: "clothing",
    notes: "Aceita qualquer pelt cru. Cured pelt é insumo de vestuário de couro.",
  },
  {
    slug: "craft-leather-jacket",
    output: { itemSlug: "leather-jacket", qty: 1 },
    inputs: [{ itemSlug: "cured-pig-pelt", qty: 4 }],
    tools: ["leather-sewing-kit"],
    method: "Combine 4 cured-pelts + leather-sewing-kit → 'Craft Leather Jacket'.",
    durationS: 30,
    category: "clothing",
    notes: "Bom isolamento térmico + proteção média. Repara com leather-sewing-kit.",
  },
  {
    slug: "craft-leather-pants",
    output: { itemSlug: "leather-pants", qty: 1 },
    inputs: [{ itemSlug: "cured-pig-pelt", qty: 4 }],
    tools: ["leather-sewing-kit"],
    method: "Combine 4 cured-pelts + leather-sewing-kit → 'Craft Leather Pants'.",
    durationS: 30,
    category: "clothing",
  },
  {
    slug: "craft-leather-vest",
    output: { itemSlug: "leather-vest", qty: 1 },
    inputs: [{ itemSlug: "cured-pig-pelt", qty: 3 }],
    tools: ["leather-sewing-kit"],
    method: "Combine 3 cured-pelts + leather-sewing-kit → 'Craft Leather Vest'.",
    durationS: 25,
    category: "clothing",
    notes: "Vest leve, sem slots de proteção balística — mas ótimo no clima.",
  },

  // ─── MISC ─────────────────────────────────────────────
  {
    slug: "combine-map-chernarus",
    output: { itemSlug: "map-chernarus", qty: 1 },
    inputs: [{ itemSlug: "map-chernarus", qty: 4 }],
    method: "Combine 4 pedaços parciais do mapa (West/East/North/South) no inventário → mapa Chernarus completo.",
    durationS: 4,
    category: "tool",
    notes: "Pedaços spawnam em casas/escolas. Mapa completo dá grid e nomes de todas as cidades.",
  },
  {
    slug: "repair-fishing-rod",
    output: { itemSlug: "fishing-rod", qty: 1 },
    inputs: [{ itemSlug: "fishing-rod", qty: 1 }],
    tools: ["duct-tape"],
    method: "Combine duct-tape com fishing-rod damaged/badly damaged → sobe 1 tier de qualidade.",
    durationS: 4,
    category: "tool",
    notes: "1 duct-tape = ~4 reparos. Não funciona em fishing-rod ruined.",
  },
  {
    slug: "clean-weapon",
    output: { itemSlug: "akm", qty: 1 },
    inputs: [{ itemSlug: "akm", qty: 1 }],
    tools: ["weapon-cleaning-kit"],
    method: "Combine weapon-cleaning-kit com a arma → remove sujeira de chuva/lama e sobe qualidade.",
    durationS: 8,
    category: "weapon",
    notes: "Cleaning kit também repara peças (suppressors, magazines). 1 kit = ~5 usos.",
  },
  {
    slug: "disinfect-wound",
    output: { itemSlug: "alcohol-tincture", qty: 1 },
    inputs: [{ itemSlug: "alcohol-tincture", qty: 1 }],
    method: "Aplique alcohol-tincture em si mesmo enquanto sangrando/com wound infection → limpa infecção em estágio inicial.",
    durationS: 6,
    category: "medical",
    notes: "Não cura sepse/cólera já em estágio avançado — só wound infection inicial. 1 frasco = ~3 usos.",
  },
];
